    ...
    <footer className="bg-gray-900 text-white mt-20" >
      ...
      <div className="grid grid-cols-1 gap-10 text-center pt-2 text-gray-400 text-sm pb-8 mt-3">
        <div className="" >
          ...
          <p className="mt-2" style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 400 }} >
        ...
        <div>
          <span className="text-xl font-bold text-teal-900" style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 500 }} >
